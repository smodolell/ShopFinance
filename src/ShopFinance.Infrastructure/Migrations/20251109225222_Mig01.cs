    ...
    public partial class Mig01 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmortizationScheduleEntry", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AmortizationScheduleEntry_Credits_CreditId",
                        column: x => x.CreditId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentApplications_AmortizationScheduleEntry_AmortizationScheduleEntryId",
                        column: x => x.AmortizationScheduleEntryId,
                        principalTable: "AmortizationScheduleEntry",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmortizationScheduleEntry_CreditId",
